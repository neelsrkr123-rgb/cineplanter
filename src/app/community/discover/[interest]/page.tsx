// app/community/discover/[interest]/page.tsx - Updated
...
export default function InterestPage() {
  ...
  // Get current user ID and name - FIXED: Use only available properties
  const currentUserId = user?.id || user?.uid || null;
  // FIXED: Use 'name' property only (no 'displayName')
