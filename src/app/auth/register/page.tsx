...
import { Eye, EyeOff, Mail, Lock, User, Film, LogIn } from 'lucide-react';
...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-purple-950 to-blue-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-gray-900/70 backdrop-blur-md rounded-2xl shadow-2xl p-8">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full bg-white/5 hover:bg-white/10 text-white py-3 rounded-lg font-semibold transition flex items-center justify-center gap-2"
        >
