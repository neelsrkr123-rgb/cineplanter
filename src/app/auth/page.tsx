        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {!isLogin && (
            <input
              ...
              className="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-3 text-white placeholder:text-gray-500 focus:outline-none focus:border-purple-500"
              required
            />
          )}
